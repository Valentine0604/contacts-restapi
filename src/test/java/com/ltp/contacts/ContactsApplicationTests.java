...
class ContactsApplicationTests {
	...
	public void getAllContactsTest() throws Exception {
		...
		mockMvc.perform(request)
			   ...
			   .andExpect(jsonPath("$[?(@.name == 'Tyrion Lannister')]").exists())
			   .andExpect(jsonPath("$[?(@.phoneNumber == '4145433332')]").exists());
	}
	...
	public void validContactCreation() throws Exception {
		...
		RequestBuilder request = MockMvcRequestBuilders.post("/contact").contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(new Contact("4","Jon", "658974521")));
